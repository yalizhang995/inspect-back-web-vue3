...
export function listInspSiteInfo(data) {
    return request({
        url: '/biz/mediaSensitiveWords/list',
        method: 'post',
        data: data
    })
}
...
export function getInspSiteInfo(data) {
    return request({
        url: '/biz/mediaSensitiveWords/getInfo',
        method: 'post',
        data: data
    })
}
...
export function addInspSiteInfo(data) {
    return request({
        url: '/biz/mediaSensitiveWords/add',
        method: 'post',
        data: data
    })
}
...
export function updateInspSiteInfo(data) {
    return request({
        url: '/biz/mediaSensitiveWords/edit',
        method: 'post',
        data: data
    })
}
...
export function delInspSiteInfo(data) {
    return request({
        url: '/biz/mediaSensitiveWords/remove',
        method: 'post',
        data: data
    })
}
...
export function editReviewResult(data) {
    return request({
        url: '/biz/mediaSensitiveWords/editReviewResult',
        method: 'post',
        data: data
    })
}
...
export function editBatch(data) {
    return request({
      url: '/biz/mediaSensitiveWords/editBatch',
      method: 'post',
      data: data
    })
}
...
export function editReviewResultBatch(data) {
    return request({
      url: '/biz/mediaSensitiveWords/editReviewResultBatch',
      method: 'post',
      data: data
    })
}
...
export function batchImport(data) {
    return request({
        ...
        url: '/biz/mediaSensitiveWords/batchImport',
        method: 'post',
        data: data
    })
}
