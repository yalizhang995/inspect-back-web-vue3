...
export function getInspSiteInfo(data) {
    return request({
        url: '/biz/sensitiveWords/getInfo',
        method: 'post',
        data: data
    })
}
...
export function editBatch(data) {
    return request({
      url: '/biz/sensitiveWords/editBatch',
      method: 'post',
      data: data
    })
}
...
export function editReviewResultBatch(data) {
    return request({
      url: '/biz/sensitiveWords/editReviewResultBatch',
      method: 'post',
      data: data
    })
}
...
export function batchImport(data) {
    return request({
        ...
        url: '/biz/sensitiveWords/batchImport',
        method: 'post',
        data: data
    })
}
