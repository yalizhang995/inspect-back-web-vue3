...
export function editBatch(data) {
    return request({
      url: '/biz/privacyLeaks/editBatch',
      method: 'post',
      data: data
    })
}
...
export function editReviewResultBatch(data) {
    return request({
      url: '/biz/privacyLeaks/editReviewResultBatch',
      method: 'post',
      data: data
    })
}
...
export function batchImport(data) {
    return request({
        ...
        url: '/biz/privacyLeaks/batchImport',
        method: 'post',
        data: data
    })
}
