        ...
        <el-dialog :title="titleTxt" :visible.sync="open" width="800px" append-to-body :close-on-click-modal="false" :close-on-press-escape="false" class="addCl" @close="cancel" >
            <el-form ref="form" :model="form" :rules="rules" label-width="0" v-loading="diaLoading">
                ...
                <div style="marginTop: -5px;">
                    <span class="spClass"><span class="x">*</span>发送单位</span>
                ...
                <!-- 触发条件 -->
                <!-- 网站 -->
                <div style=";position: relative;marginTop: -5px;marginBottom:15px" class="cftjClass">
                    <span class="spClass">触发条件</span>
                    <!-- <div>日报<span>统计昨日数据</span></div> -->
                    <el-checkbox v-model="checked2" disabled>日报</el-checkbox>
                    <span class="tjsj">统计昨日数据</span>
                </div>
                ...
                <div class="pcBox">
                    ...
                    <div class="pcCen">
                        ...
                        <el-pagination
                            ...
                            :total="pcTotal"
                            v-show="pcTotal>0"
                            :current-page="pcQueryParams.pgNum"
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                occurrenceUnit: [{ required: true, message: '请选择发送单位', trigger: 'change' }],
    ...
    created() {
        ...
        if(this.openType == 1){ // 新增
            ...
            this.form.occurrenceUnit = this.editObj.occurrenceUnit; // 发送单位
            ...
            if(this.editObj.siteInfos){
                ...
                getUnit({siteCodes: this.siteCodesAll,codeType: 1}).then((res)=>{
                    this.cities = [];
    ...
    methods: {
                ...
                if (valid) {
                    ...
                    if(!atLeastOneNonEmpty){
                        ...
                        if(this.openType == 1){ // 新增
                            ...
                            // 发送单位是否有变化
                            if(this.form.occurrenceUnit != this.editObj.occurrenceUnit || isSubset == true){
        ...
        siteCodeSearch(){
            console.log('ok')
            // tbSiteCode
            getUnit({siteCodes: this.siteCodesAll,name: this.tbSiteCode,codeType: 1}).then((res)=>{
                this.cities = [];
                this.cities = res.data;
                this.checkAll = false;
                this.switchS = false;
        ...
        // 清空树搜索条件
        clearSearch(){
            getUnit({siteCodes: this.siteCodesAll,name: null,codeType: 1}).then((res)=>{
                this.cities = [];
                this.cities = res.data;
                this.checkAll = false;
                this.switchS = false;
        ...
        productTypeChange(){
            ...
            if(this.form.productType == 1){ // 网站
                ...
                this.mediaSiteNames = [];
                this.form.confirmedDetailsArr = [10];
            }else if(this.form.productType == 2){ // 新媒体
                this.form.confirmedDetailsArr = [101];
            }
            this.siteCode = null;
        ...
        pcChange(){
            ...
            this.$set(this.pcQueryParams,'pgNum',1)
            // this.pcQueryParams.pgNum = 1;
            this.pcQueryParams.siteCode = this.siteCode;
            this.pcQueryParams.siteType = this.form.siteType;
            this.getMediaListFn(1);
        ...
        handleSelectionChange3(selection,row) {
            ...
            if(selection.includes(row) == true){
                const exists = this.mediaSiteNames.some(item => item.siteCodeMedia === row.siteCodeMedia);
                if (!exists) {
...
<style scoped lang="scss">
    ...
    .dxDivBox,.dxDivBox2,.dxDivBox3,.dxDivBox4,.dxDivBox5,.dxDivBox6,.dxDivBox7,.dxDivBox10,.dxDivBox11,.dxDivBox12,.dxDivBox13{
        display: flex;
        align-items: center;
        position: absolute;
        top: 52px;
