        ...
        <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                <el-row>
                    ...
                    <!-- 节点ip，节点端口 -->
                    <el-col :span="12">
                        <el-form-item label="节点IP" prop>
                            <el-input v-model="form.nodeIp" placeholder="请输入节点IP" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="节点端口" prop>
                            <el-input v-model="form.nodePort" placeholder="请输入节点端口" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
