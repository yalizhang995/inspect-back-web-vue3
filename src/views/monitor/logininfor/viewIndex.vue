<template>
    <div class="app-container">
        ...
        >
            ...
            <el-table-column label="用户名称" prop="userName" min-width="100" :show-overflow-tooltip="true"  sortable="custom" :sort-orders="['descending', 'ascending']" />
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            viewList(this.addDateRange(this.queryParams, this.dateRange)).then(
                response => {
                    ...
                    for (var i in this.list) {
                        ...
                        } else if (this.list[i].loginType == 100) {
                            this.list[i].loginTypeTxt = "退出登录";
                        }else {
        ...
        resetQuery() {
            ...
            this.queryParams.pageNum = 1;
            this.queryParams.appName = 'inspect-view';
