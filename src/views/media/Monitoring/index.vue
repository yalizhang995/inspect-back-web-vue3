<template>
    <div class="app-container">
        ...
        >
            ...
            <!-- <el-table-column prop="siteCodeMedia" label="新媒体标识码" width="240" sortable="custom"></el-table-column> -->
            <!-- <el-table-column prop="user.name" label="账号信息" width="300"  show-overflow-tooltip></el-table-column> -->
            <el-table-column prop="user.name" label="账号信息" width="300" show-overflow-tooltip>
            ...
            <el-table-column prop="siteName" label="文章标题" show-overflow-tooltip>
                <template slot-scope="scope">
