<template>
    <div class="app-container">
            ...
            <el-tab-pane label="待整改" name="1">
                ...
                >
                    ...
                    <el-form-item label="漏洞级别" prop="vulLevel">
                        <el-select v-model="queryParams.vulLevel" clearable placeholder="请选择漏洞级别">
                            <el-option
                ...
                >
                    ...
                    <el-table-column prop="qod" label="准确性评分" width="160" align="center"></el-table-column>
        ...
        <el-drawer :title="ctTitle" :visible.sync="drawer" :direction="direction" :before-close="handleClose">
            ...
            <div class="msBoxx3">
                <span>URL</span>
                <el-select v-model="infoObj.siteUrl" placeholder="请选择" size="small" style="width:60%;marginRight:10px">
                    <el-option
                ...
                <el-button type="text" size="small" @click="dzChange(infoObj.siteUrl)">访问</el-button>
            </div>
    ...
    methods: {
        ...
        setInfo(row,delIndex){
            ...
            SystemMonitoringGetInfo({id:id}).then(response => {
                ...
                this.infoObj.urlArr = [{ label: this.infoObj.siteUrl, value: this.infoObj.siteUrl }]
                // 危险等级
