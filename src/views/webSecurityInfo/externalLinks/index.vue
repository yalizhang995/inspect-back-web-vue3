         ...
         <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="待审核" name="1">
                ...
                >
                    ...
                    <el-table-column prop="title" label="暗链地址" width="320" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <span class="dz" @click="dzChange(scope.row.hideUrl)">{{ scope.row.hideUrl}}</span>
                        </template>
                    </el-table-column>
                    ...
                    <!-- <el-table-column prop="hideUrl" label="错链地址" width="320"></el-table-column> -->
                    <el-table-column prop="hideTitle" label="暗链网站标题" width="220" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="hideQod" label="暗链可信度评分" width="140" align="center"></el-table-column>
