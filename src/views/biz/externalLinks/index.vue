            ...
            <div class="tabBox">
                ...
                >
                    ...
                    <el-table-column label="" prop="channelName" width="60">
                        <template slot-scope="scope">
                            <el-tooltip  class="item" effect="dark" content="点此复制外链链接+网站标识码" placement="top-start">
                    ...
                    <el-table-column prop="fromTitles" label="父页面信息" width="280" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="fromUrls" label="父页面所在链接" width="280" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <span class="dz" @click="dzChange(scope.row.fromUrls)">{{ scope.row.fromUrls}}</span>
                        </template>
                    </el-table-column>

                    <el-table-column prop="fromTitle" label="外链所在页面标题" width="280" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="fromUrl" label="外链所在页面地址" width="280" show-overflow-tooltip>
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="auditTime" label="审核时间" width="180" v-if="activeName != '1'"></el-table-column>
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick" v-if="!upHeightType">
            ...
            <el-tab-pane label="待审核" name="1">
                ...
                >
                    ...
                    <el-form-item label="是否信任" prop="trustFlag">
                        <el-select v-model="queryParams.trustFlag" clearable placeholder="请选择是否信任" style="width:310px">
                            <el-option
                    ...
                    <!-- <el-form-item label="审核状态" prop="showState">
                        <el-select v-model="queryParams.showState" clearable placeholder="请选择审核状态" style="width:310px">
                            <el-option
                    ...
                    <el-form-item label="数据ID" prop="idStr">
                        <el-input v-model="queryParams.idStr" placeholder="请输入ID" clearable style="width:310px" @keyup.enter.native="handleQuery" @clear="queryParams.idStr=null" />
                    </el-form-item>
                    ...
                    <el-form-item label="订单批次" prop="">
                        <el-select v-model="queryParams.batchId" filterable remote placeholder="请输入订单名称或网站标识码" :remote-method="remoteMethod2" clearable style="width:730px" :disabled="queryParams.dataRangeType == 1" @clear="queryParams.batchId=null">
                            <el-option
                    ...
                    <el-form-item label="外链类型" prop="errorTypesIn">
                        <el-select v-model="queryParams.errorTypesIn" clearable placeholder="请选择外链类型" style="width:310px" multiple collapse-tags>
                            <el-option
                    ...
                    <el-form-item label="外链域名" prop="domain">
                        <el-input v-model="queryParams.domain" placeholder="请输入外链域名" clearable style="width:310px;" @clear='queryParams.domain=null' />
                    </el-form-item>
                    <el-form-item label="外链链接" prop="urlHash">
                        <el-input v-model="queryParams.urlHash" placeholder="请输入外链链接加网站标识码" clearable style="width:730px;" />
                    </el-form-item>
                    <el-form-item label="父页面信息" prop="fromTitle">
                        <el-input v-model="queryParams.fromTitle" placeholder="请输入父页面信息" clearable style="width:730px;" />
                    </el-form-item>
                    <el-form-item label="父页面链接" prop="fromUrl">
                        <el-input v-model="queryParams.fromUrl" placeholder="请输入父页面所在链接" clearable style="width:730px;" />
                    </el-form-item>
                    <el-form-item label="来源" prop="source">
                        <el-select v-model="queryParams.source" clearable placeholder="请选择来源" style="width:310px">
                            <el-option
                ...
                <el-row :gutter="10" class="mb8" style="display:flex;">
                    <div class="divdiv">
                        <p>
                            ...
                            <el-col :span="1.5">
                                <el-button type="primary" plain icon="el-icon-edit" size="mini" :disabled="multiple">批量整改</el-button>
                            </el-col> -->
                            <el-col :span="1.5">
                                <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport">导出</el-button>
                            </el-col>
                ...
                >
                    ...
                    <el-table-column prop="reviewDesc" label="复核结果" min-width="140" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="reviewDescTypeTxt" label="复核结果类型" min-width="140" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="fromTitles" label="父页面信息" width="200" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="fromUrls" label="父页面所在链接" width="300" show-overflow-tooltip>
                        <template slot-scope="scope">
                            <span class="dz" @click="dzChange(scope.row.fromUrls)">{{ scope.row.fromUrls}}</span>
                        </template>
                    </el-table-column>
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-tooltip class="item" effect="dark" content="整改" placement="top">
                             ...
                             <!-- <el-tooltip class="item" effect="dark" content="编辑" placement="top">
                                <i class="el-icon-edit-outline" style="marginLeft:10px;cursor: pointer;font-size:15px" @click="handleUpdate(scope.row)"></i>
                            </el-tooltip>
            ...
            <el-tab-pane label="可疑外链" name="2">
                ...
                >
                    ...
                    <el-form-item label="依据" prop="exemptionId">
                        <el-input v-model="queryParams.exemptionId" placeholder="请输入依据ID" clearable style="width:310px" @keyup.enter.native="handleQuery"  @clear="queryParams.exemptionId=null" />
                    </el-form-item>
                    <el-form-item label="复核状态" prop="reviewState">
                        <el-select v-model="queryParams.reviewState" clearable placeholder="请选择复核状态" style="width:310px">
                            <el-option
            ...
            <el-tab-pane label="信任外链" name="3">
                ...
                >
                    ...
                    <el-form-item label="订单批次" prop="">
                        <el-select v-model="queryParams.batchId" filterable remote placeholder="请输入订单名称或网站标识码" :remote-method="remoteMethod2" clearable style="width:730px" :disabled="queryParams.dataRangeType == 1" @cleat="queryParams.batchId=null">
                            <el-option
                            v-for="item in pcList"
                            :key="item.value"
                            :label="item.label"
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                showState: [{ required: true, message: '请选择操作类型', trigger: 'change' }],
    ...
    beforeRouteLeave(to, from, next) {
        ...
        console.log('离开页面了！');
        // 确保调用next()以便路由继续跳转
        sessionStorage.removeItem('ExternalLinksObj')
    ...
    created() {
        // 外链规则-客户免检
        if(sessionStorage.getItem('ExternalLinksObj')){
            let obj = JSON.parse(sessionStorage.getItem('ExternalLinksObj'));
            console.log(obj,'obj')
    ...
    methods: {
            ...
            listInspSiteInfo(this.queryParams).then(response => {
                ...
                for(var i in this.inspSiteInfoList){
                    ...
                    if(this.inspSiteInfoList[i].trustFlag == 1){
                        ...
                        this.inspSiteInfoList[i].trustFlagTxt = '未知';
                        this.inspSiteInfoList[i].color = '#999999';
                    }

                    // 审核状态
                    // for(var z in this.showStateList){
                    //     if(this.inspSiteInfoList[i].showState == this.showStateList[z].val){
                    //         console.log('ok')
                    //         this.inspSiteInfoList[i].showStateTxt = this.showStateList[z].val;
                    //         console.log(this.inspSiteInfoList[i].showStateTxt)
                    //     }else{
                    //         this.inspSiteInfoList[i].showStateTxt = '--';
                    //     }
                    // }
                    ...
                    if(this.inspSiteInfoList[i].auditType == 0){
                        ...
                        this.inspSiteInfoList[i].auditTypeTxt = 'AI审核';
                    }else{
                        this.inspSiteInfoList[i].auditTypeTxt = '--';
                    }
                    // 依据
                    if(this.inspSiteInfoList[i].according){
                        this.inspSiteInfoList[i].descriptionTxt = this.inspSiteInfoList[i].according.description;
                    }else{
                        this.inspSiteInfoList[i].descriptionTxt = '--';
                    }
                    ...
                    // }
                    // 错链所在页面标题、地址
                    if(!this.inspSiteInfoList[i].fromTitles){
                        this.inspSiteInfoList[i].fromTitles = '--';
                    }
                    if(!this.inspSiteInfoList[i].fromUrls){
                        this.inspSiteInfoList[i].fromUrls = '--';
                    }
                    // 压缩包子路径
                    ...
                    if(this.inspSiteInfoList[i].reviewDescType == 10){
                        ...
                        this.inspSiteInfoList[i].reviewDescTypeTxt = '--';
                    }
        ...
        handleQuery() {
            ...
            console.log(this.queryParams.treeInfo.psCode,'123')
            console.log(this.activeName,'activeName')
            if(this.activeName == '1'){ // 待审核
                if(this.queryParams.domain != null || this.queryParams.treeInfo.psCode != null || this.queryParams.siteCode != null || this.queryParams.batchId != null || this.queryParams.idStr != null){
                    this.getList();                
                }else{
                    this.$modal.msgWarning("主管单位/网站标识码/订单批次/数据ID/外链域名/请至少输入其中一项");
                }
            }else if(this.activeName == '2' || this.activeName == '3'){ // 可疑外链、信任外链
                if(this.queryParams.domain != null || this.queryParams.exemptionId != null || this.queryParams.treeInfo.psCode != null || this.queryParams.siteCode != null || this.queryParams.batchId != null || this.queryParams.idStr != null){
                    this.getList();                
                }else{
                    this.$modal.msgWarning("主管单位/网站标识码/订单批次/数据ID/外链域名/依据请至少输入其中一项");
                }
            }
            ...
            //     this.getList();                
            // }else{
            //     this.$modal.msgWarning("主管单位/网站标识码/订单批次/数据ID请至少选择其中一项");
            // }
        },
        /** 重置按钮操作 */
        resetQuery() {
            ...
            this.$refs["form4"].validate(valid => {
                if (valid) {
                    ...
                    if(this.form4.type == 2){ // 大批量
                        ...
                        // let fileName = '外链信息数据-'+this.formatDate(new Date());
                        let fileName = '';
                        ...
                        this.download(
                            "biz/externalLinks/export",this.queryParams,
                            `${fileName}.xlsx`
                        ).then((res)=>{
                            this.open4 = false;
                        });
        ...
        handleUpdate3(row,index) {
            ...
            getInspSiteInfo({id:id}).then(response => {
                ...
                this.form3.siteCode = response.data.siteCode;
        ...
        handleDown(){
            if(this.fileType == 1){ // 信任
                let fileName = '网站外链信任模板';  
                this.download2(
                    "common/download/downloadExcelTpl?type=30",'',
                    `${fileName}.xlsx`
                ).then((res)=>{});
                              
            }else if(this.fileType == 2){ // 整改
                let fileName = '网站外链整改模板';
                this.download2(
                    "common/download/downloadExcelTpl?type=36",'',
                    `${fileName}.xlsx`
                ).then((res)=>{});
            }else if(this.fileType == 3){ // 审核
                let fileName = '网站外链审核模板';
                this.download2(
                    "common/download/downloadExcelTpl?type=37",'',
                    `${fileName}.xlsx`
                ).then((res)=>{});
            }
        ...
        handleClick(tab, event) {
            ...
            if(tab.name == '1'){ // 待审核
                ...
                if(this.queryParams.domain != null || this.queryParams.treeInfo.psCode != null || this.queryParams.siteCode != null || this.queryParams.batchId != null || this.queryParams.idStr != null){ // 外链域名
                    this.getList();                
                }else{
                    this.inspSiteInfoList = [];
                    this.total = 0;
                ...
                if(sessionStorage.getItem('ExternalLinksObj')){ // 客户免检进入
                    let obj = JSON.parse(sessionStorage.getItem('ExternalLinksObj'));
                    this.queryParams.exemptionId = obj.idStr;
                }
                this.queryParams.trustFlag = 2;
                ...
                this.queryParams.orderTypes = [{ code: 1, name: 'ate' }]; // 表格排序
                this.queryParams.searchDateKey = 'ate';
                if(this.queryParams.domain != null || this.queryParams.exemptionId != null || this.queryParams.treeInfo.psCode != null || this.queryParams.siteCode != null || this.queryParams.batchId != null || this.queryParams.idStr != null){ // 外链域名、依据
                    this.getList();                
                }else{
                    this.inspSiteInfoList = [];
                    this.total = 0;
