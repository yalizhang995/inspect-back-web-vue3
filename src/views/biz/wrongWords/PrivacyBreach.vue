                    ...
                    <el-form-item label="订单批次" prop="">
                     ...
                     <el-form-item label="任务ID" prop="pid">
                        <el-input
                            ...
                            placeholder="请输入任务ID"
                            clearable
                            @keyup.enter.native="handleQuery"style="width:310px"
            ...
            <el-tab-pane label="已审核错误" name="3">
                ...
                >
                    ...
                    <el-table-column prop="word" label="错敏词" width="200" fixed show-overflow-tooltip>
                        <template slot-scope="scope">
                                <!-- <el-tooltip class="item" effect="dark" :content="scope.row.word" placement="top"> -->
                                <span class="sxw">{{scope.row.word}}</span>
                            <!-- </el-tooltip> -->
                        </template>
                    </el-table-column>
                    <el-table-column prop="illegalRemarksText" label="问题备注" width="200" align="">
    ...
    methods: {
            ...
            this.$refs["form3"].validate(valid => {
                if (valid) {
                    ...
                    if(this.form3.type == 2){ // 大批量
                        ...
                        this.download(
                            "biz/privacyLeaks/export",this.queryParams,
                            `${fileName}.xlsx`
                        ).then((res)=>{
                            this.open3 = false;
                        });
        ...
        handleDown(){
            if(this.fileType == 1){ // 审核
                let fileName = '网站隐私泄露审核模板';  
                this.download2(
                    "common/download/downloadExcelTpl?type=7",'',
                    `${fileName}.xlsx`
                ).then((res)=>{});
                              
            }else if(this.fileType == 2){ // 整改
                let fileName = '网站隐私泄露整改模板';
                this.download2(
                    "common/download/downloadExcelTpl?type=8",'',
                    `${fileName}.xlsx`
                ).then((res)=>{});
            }
