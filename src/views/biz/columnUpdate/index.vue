<template>
    <div class="app-container">
        ...
        >
            ...
            <el-table-column prop="siteName" label="网站名称" min-width="180" fixed show-overflow-tooltip>
                <template slot-scope="scope">
                    <span class="dz" @click="dzChange(scope.row.siteUrl)">{{ scope.row.siteName}}</span>
                </template>
            </el-table-column>
             <el-table-column prop="siteCode" label="网站标识码" min-width="120" align="center" sortable="custom"></el-table-column>
            ...
            <el-table-column prop="name" label="栏目名称" min-width="180" align="center" show-overflow-tooltip>
                <template slot-scope="scope">
                    <span class="dz" @click="dzChange(scope.row.url)">{{ scope.row.name}}</span>
                </template>
            </el-table-column>
            
            <el-table-column prop="channelTypeText" label="栏目分类" min-width="200" align="center" show-overflow-tooltip></el-table-column>
            <el-table-column prop="overdueStateTxt" label="逾期不更新状态" align="center" min-width="120">
                <template slot-scope="scope">
                    <span class="wtjb"><span class="yd" :style="{background: scope.row.overdueStateBgColor}"></span>{{ scope.row.overdueStateTxt}}</span>
                </template>
            </el-table-column>
            <el-table-column prop="noUpdateDay" label="未更新天数" min-width="120" align="center" sortable="custom"></el-table-column>
            <!-- <el-table-column prop="updateTitle" label="更新标题" width="240" >
                <template slot-scope="scope">
            ...
            <el-table-column prop="updateUrl" label="更新文章" width="240">
                <template slot-scope="scope">
            ...
            <el-table-column prop="updateTitle" label="更新标题" min-width="460" show-overflow-tooltip>
                <template slot-scope="scope">
                        <!-- <el-tooltip class="item" effect="dark" :content="scope.row.updateTitle" placement="top" v-if="scope.row.updateTitle!='--'">
            ...
            <el-table-column prop="specialTagTxt" align="center" label="特殊情况" min-width="140"></el-table-column>
            <el-table-column prop="renewTime" label="最后更新时间" min-width="160" sortable="custom"></el-table-column>
            <el-table-column prop="scanDate" label="监测时间" min-width="160"></el-table-column>
                ...
                <div class="concon">
                    <div class="conTop">
                        <ul class="ul">
                            ...
                            <li>栏目名称：<span>{{editObj.name}}</span></li>
                            <li>栏目分类：<span>{{editObj.channelTypeText}}</span></li>
                    ...
                    <el-form ref="formform" :model="form" :rules="rules" label-width="120px" style="marginTop:20px">
                        ...
                        <el-form-item label="未更新天数" prop="noUpdateDay">
                            <el-input v-model="form.noUpdateDay"  style="width:97%"></el-input>
                        </el-form-item>
...
export default {
    ...
    methods: {
            ...
            this.$refs["form4"].validate(valid => {
                if (valid) {
                    ...
                    if(this.form4.type == 2){ // 大批量
                        ...
                        let fileName = '栏目更新数据'
                        this.download(
                            "biz/pageUpdate/channelUpdateExport",this.queryParams,
                            `${fileName}.xlsx`
                        ).then((res)=>{
                            this.open4 = false;
                        });
        ...
        // 跳转稿件页面
        goManuscript(item){
            sessionStorage.setItem('columnUpdateObj',JSON.stringify(item))
