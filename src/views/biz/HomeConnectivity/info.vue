    ...
    <div class="app-container">
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="确定不连通" name="2">
                ...
                >
                    <el-table-column prop="index" label="序号" width="78" align="center"></el-table-column>
                    ...
                    <el-table-column prop="siteCode" label="网站标识码" sortable="custom" width="110"></el-table-column>
            ...
            <el-tab-pane label="成功连通" name="1">
                ...
                >
                    ...
                    <el-table-column prop="siteCode" label="网站标识码" sortable="custom" width="110" align="center"></el-table-column>
                    <el-table-column prop="scanTime" label="监测时间"  width="166" align="center"> </el-table-column>
                    <el-table-column prop="httpStateTxt" label="监测结果"  width="120" align="center">
                        <template slot-scope="scope">
                            <span class="wtjb"><span class="yd" :style="{background: scope.row.httpStateTxtBgColor}"></span>{{ scope.row.httpStateTxt}}</span>
    ...
    data() {
     ...
     beforeRouteLeave(to, from, next) {
        ...
        if(this.isGoInfo == false){
             sessionStorage.removeItem('HomeConnectivityInfo')
             sessionStorage.removeItem('HomeConnectivityInfoType')
        }
        next();

    },
    created() {
        if(sessionStorage.getItem('HomeConnectivityInfo')){
            this.queryParams.siteCode = JSON.parse(sessionStorage.getItem('HomeConnectivityInfo')).siteCode;
            this.scanDate = [
                JSON.parse(sessionStorage.getItem('HomeConnectivityInfo')).scanDate,
                JSON.parse(sessionStorage.getItem('HomeConnectivityInfo')).scanDate
            ]
            this.queryParams.scanStartDate = JSON.parse(sessionStorage.getItem('HomeConnectivityInfo')).scanDate;
            this.queryParams.scanEndDate = JSON.parse(sessionStorage.getItem('HomeConnectivityInfo')).scanDate;
            // this.queryParams.siteCode = JSON.parse(sessionStorage.getItem('HomeConnectivityInfo')).siteCode;
        }
        if(sessionStorage.getItem('HomeConnectivityInfoType')){
            this.activeName = sessionStorage.getItem('HomeConnectivityInfoType');
            this.queryParams.httpState = JSON.parse(sessionStorage.getItem('HomeConnectivityInfoType'))
        }
        this.getList();
        this.getTreeselect();
    },
       ...
       /** 查询站点关系下拉树结构 */
        ...
        goBack(){
            ...
            this.$store.dispatch('tagsView/delView', view).then(({ visitedViews }) => {
                ...
                this.$router.replace({ path: '/machine/HomeConnectivity'});
                // this.$router.go(-1);    
            })
        },
